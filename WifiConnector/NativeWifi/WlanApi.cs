    ...
    public class WlanClient
    {
        ...
        public class WlanInterface
        {
            ...
            private void SetInterfaceInt(Wlan.WlanIntfOpcode opCode, int value)
            {
                ...
                try
                {
                    Wlan.ThrowIfError(Wlan.WlanSetInterface(client.clientHandle, info.interfaceGuid, opCode, sizeof(int), valuePtr, IntPtr.Zero));
                }
                finally
                {
            ...
            private int GetInterfaceInt(Wlan.WlanIntfOpcode opCode)
            {
                ...
                Wlan.ThrowIfError(Wlan.WlanQueryInterface(client.clientHandle, info.interfaceGuid, opCode, IntPtr.Zero, out valueSize, out valuePtr, out opcodeValueType));
                try
                {
